...
import os
import torch
from exp_long_term_forecasting import Exp_Long_Term_Forecasting
import random
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', type=str, default='Electricity', help='dataname')
    ...
    parser.add_argument('--pred_len', type=int, default=720, help='pred_len')
    ...
    parser.add_argument('--forecast_visual_flag', type=bool, default=False, help='visual plot')
    
    # model define
    
    
    parser.add_argument('--d_model', type=int, default=256, help='dimension of model')
    parser.add_argument('--block_layers', type=int, default=2, help='num of encoder layers')
    ...
    if args.data_name =='Electricity':
        ...
        data = 'custom'
        root_path = './dataset/long_term_forecast/electricity'
    ...
    if args.data_name =='Traffic':
        ...
        data = 'custom'
        root_path = './dataset/long_term_forecast/traffic'
    
    if args.data_name =='Exchange':
        p = 8
        dis_dim = 4
        data_path = 'exchange_rate.csv'
        data = 'custom'
        root_path = './dataset/long_term_forecast/exchange_rate'
    
    if args.data_name =='ILI':
        p = 7
        dis_dim = 3
        data_path = 'national_illness.csv'
        data = 'custom'
        root_path = './dataset/long_term_forecast/illness'
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_sl{}_pl{}_mr{}_dm{}_ln{}_lradj{}_lr{}_sm_loss_w{}'.format(
                args.task_name,
                args.model,
                args.data_name,
                args.seq_len,
    ...
    expd_path = './Results_long_term_new/' + args.data_name + '/'+ str(args.pred_len) + '/' + args.model + '/'
